...
/* Modify lines below */
var catchall = "woodback.club"; // For the accounts (if you win)
var password = 'Newyorkmets44'; // For the accounts (if you win)
var retryDelay = 10000; // How many miliseconds before retrying if error
var tasks = 1000; //Change this to the amount of accounts you would like entered
/* End */
